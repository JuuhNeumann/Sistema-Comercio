...
namespace SistemaComercioLibrary.Classes
{
    public class Fornecedor
    {
        ...
        [Required]
        [MaxLength(30, ErrorMessage = "O bairro não pode ultrapassar 30 caracteres!")]
        public string Bairro { get; set; }
        [Required]
        [MaxLength(30, ErrorMessage = "A cidade não pode ultrapassar 30 caracteres!")]
        public string Cidade { get; set; }
        [Required]
        [MaxLength(30, ErrorMessage = "O estado não pode ultrapassar 30 caracteres!")]
